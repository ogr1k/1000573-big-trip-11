...
const createAddEditTripFormTemplate = () => {
  return (
...
render(mainTripElement, createInfoTemplate(), `afterbegin`);

const tripInfoElement = document.querySelector(`.trip-info__main`);
render(tripInfoElement, createPriceTemplate(), `afterend`);
...
render(tripDaysElement, createFirstDayItems(), `beforeend`);
render(tripDaysElement, createSecondDayItems(), `beforeend`);
render(tripDaysElement, createThirdDayItems(), `beforeend`);
